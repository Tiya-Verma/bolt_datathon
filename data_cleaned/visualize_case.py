...
# ---------- Load data ----------
stadium = safe_read_csv("data_cleaned/stadium_operations_clean.csv")
if stadium is None:
    # fallback to provided Excel if cleaned CSV not present
    stadium = safe_read_excel("BOLT-UBC-First-Byte-Stadium-Operations.xlsx")

merch = safe_read_csv("data_cleaned/merchandise_sales_clean.csv")
fan = safe_read_csv("data_cleaned/fanbase_engagement_clean.csv")
